...
0.19);">
    ...
    <form action="../process/editSeriesProcess.php" method="post">
        ...
        <div class="mb-3">
            ...
            <select class="form-control selectpicker"  name="genre[]" id="genre" multiple>
        ...
        <div class="mb-3">
            ...
            <input class="form-control" id="realese" name="realese" value="<?php echo $_GET['realese'];?>"
                aria-describedby="emailHelp">
        </div>
        <div class="mb-3">
            <label for="exampleInputEmail1" class="form-label">Episode</label>
            <input class="form-control" id="episode" name="episode" value="<?php echo $_GET['episode'];?>"
                aria-describedby="emailHelp">
        </div>
        <div class="mb-3">
            <label for="exampleInputEmail1" class="form-label">Season</label>
            <input class="form-control" id="season" name="season" value="<?php echo $_GET['season'];?>"
                aria-describedby="emailHelp">
        </div>
        <div class="mb-3">
            ...
            <textarea class="form-control" id="synopsis" name="synopsis"
                rows="3"><?php echo $_GET['synopsis'];?></textarea>
        </div>
